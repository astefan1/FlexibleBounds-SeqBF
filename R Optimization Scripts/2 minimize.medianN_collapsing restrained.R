...
minimize.medianN.r <- function(params, sim.H0, sim.H1, max.FP = 0.05, max.FN = 0.2, BF.column = 5){
  ...
  # Compute Result
  N <- (median.H0 + median.H1)/2 + penalty
